...
brew "asdf"               # Extendable version manager for multiple programming languages
brew "antidote"           # Spell checker and grammar corrector
brew "bash"               # Bash shell
brew "bash-completion"    # Bash completion support
brew "bash-snippets"      # Collection of useful bash scripts
brew "bat"                # Cat clone with syntax highlighting
brew "bpytop"             # Resource monitor written in Python
brew "broot"              # Interactive file manager
...
brew "diff-so-fancy"      # Git diff highlighter
...
brew "ideviceinstaller"   # iOS device management command-line tools
brew "ios-deploy"         # Command-line utility to deploy iOS apps to devices
...
brew "moreutils"          # Collection of tools that make the basic UNIX commands more powerful
brew "n"                  # Node.js version management
...
brew "pup"                # Command-line HTML parsing tool
brew "pyenv"              # Python version management
brew "python3"            # Python programming language
brew "ranger"             # File manager with VI key bindings
brew "rbenv"              # Ruby version management
brew "recode"             # Charset converter and encoder/decoder
brew "ripgrep"            # Line-oriented search tool
brew "rust"               # Systems programming language
brew "screenfetch"        # Fetches system/theme information in terminal
brew "shellcheck"         # Static analysis tool for shell scripts
brew "spoof-mac"          # Change your MAC address
...
brew "webp"               # Image format for the web
brew "weechat"            # Fast, light, and extensible IRC client
brew "wget"               # Internet file retriever
brew "wv"                 # Programs to access Microsoft Word documents
brew "yarn"               # Package manager for JavaScript
brew "youtube-dl"         # Command-line program to download videos from YouTube and other sites
brew "z"                  # Jump around directory
...
cask "daisydisk"                     # Disk usage visualizer and cleanup tool
cask "dash"                          # Documentation browser and code snippet manager
cask "dbeaver-community"             # Free multi-platform database tool for developers
cask "docker"                        # Open platform for developing, shipping, and running applications
cask "docker-toolbox"                # Legacy version of Docker tools
...
cask "hazel"                         # Automated organization for your files and folders
cask "hammerspoon"                   # Desktop automation tool
cask "imagealpha"                    # Lossy PNG compressor
...
cask "visual-studio-code"            # Source code editor developed by Microsoft
...
#mas "Amphetamine", id: 937984704          # App for keeping your Mac awake
#mas "Coin Tick", id: 1141688067           # Cryptocurrency ticker with notifications
#mas "Dropover", id: 1355679052            # App for simplifying drag and drop on your Mac
#mas "iAWriter", id: 775737590             # Distraction-free writing app
#mas "Keynote", id: 409183694              # Apple's presentation software
#mas "Magnet", id: 441258766               # Window manager for organizing your desktop
#mas "Numbers", id: 409203825              # Apple's spreadsheet application
#mas "Pages", id: 409201541                # Apple's word processor and page layout app
#mas "Strongbox", id: 897283731            # Securely store your passwords and sensitive information
#mas "Tampermonkey", id: 1482490089        # Userscript manager for web browsers
#mas "Xcode", id: 497799835                # Development environment for macOS and iOS
